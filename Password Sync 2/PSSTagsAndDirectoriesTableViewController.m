...
#define kSettingsSectionNumber 0
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == kSettingsSectionNumber) {
        // Submenus
        ...
        if (indexPath.row == 0) {
            ...
            cell.imageView.image = [[UIImage imageNamed:@"Wrench"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
